...
const HomePage = () => {
  ...
  return (
    <div className="flex justify-center h-screen items-center">
          ...
          <tr className="border-collapse border border-gray-400">
            ...
            <td className="px-4">
              <button
                ...
                onClick={() => openModalHandler(data, "details")}
              >
                Details
              </button>
            </td>
            <td className="px-4">
              <button
                ...
                onClick={() => openModalHandler(data, "delete")}
              >
                Delete
              </button>
            </td>
            <td className="px-4">
              <button
                ...
                onClick={() => openModalHandler(data, "edit")}
              >
                Edit
              </button>
            </td>
      ...
      {modalType === "details" && (
        <DetailModel data={selectedUser} isOpen={true} onClose={closeModal} />
      )}
      {modalType == "delete" && (
        <DeleteModel data={selectedUser} isOpen={true} onClose={closeModal} />
      )}
      {modalType == "edit" && (
        <EditModel data={selectedUser} isOpen={true} onClose={closeModal} />
      )}
    </div>
  );
};
