    ...
    <div>
      <div className="flex justify-center">
        <form className="w-full max-w-xl">
          <p className="text-3xl font-bold mt-4 mb-8 place-self-center">
            Partner With Us
          </p>
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
              <label
                className="w-full md:w-1/2 px-3 mb-6 md:mb-0 text-lg"
                // for="grid-first-name"
              >
                First Name
              </label>
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0 text-lg">
              <label
